...
class MainMenu:
    def __init__(self):
        ...
        self.btn_start.place(x=512-200, y=330, width=398, height=115)
        ...
        self.btn_statystyki.place(x=512-200, y=330+150, width=398, height=115)
        ...
        self.btn_tworcy.place(x=512-200, y=330+300, width=398, height=115)
